module.exports.signUpErrors = (err) => {
	...
	if (err.message.includes("firstname")) errors.firstname = "firstname incorrect ou déjà pris";
	if (err.message.includes("email")) errors.email = "Email incorrect";
	if (err.message.includes("password")) errors.password = "Mot de passe incorrect";
	if (err.code == 11000 && Object.keys(err.keyValue)[0].includes("firstname")) errors.email = "Ce firstname est déjà pris";
